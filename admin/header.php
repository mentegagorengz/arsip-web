    ...
    <div style="overflow-y: auto; height: 100vh;">
        ...
        <div class="left-sidebar-pro">
            <nav id="sidebar" style="max-width: 2px;">
                ...
                <div class="left-custom-menu-adp-wrap comment-scrollbar" style="overflow-y: auto; max-height: 100vh;">
                    <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                        ...
                        <ul class="metismenu" id="menu1">
                            ...
                            <li>
                                <a href="header.php?logout=true" aria-expanded="false"><span class="educate-icon educate-pages icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Keluar</span></a>
                            </li>
            ...
            <div id="mobile-sidebar" style="position: fixed; top: 0; left: -100%; width: 280px; height: 100vh; background: white; z-index: 1000; transition: left 0.3s ease; box-shadow: 2px 0 10px rgba(0,0,0,0.3);">
                ...
                <nav style="padding: 15px 0;">
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        ...
                        <li>
                            <a href="header.php?logout=true" style="display: block; padding: 15px 20px; text-decoration: none; color: #333;">
